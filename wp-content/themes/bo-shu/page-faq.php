                    ...
                    <ul>
                        ...
                        <li><a class="subheading-a" href="#"> 運送政策
                            ...
                            <div class="content-div">
                                ...
                                <ul class="dot-ul">
                                    ...
                                    <li>客戶網上下單前請確保收件人名稱、收件人電話號碼及收件地址正確，提供錯誤的資料導致貨品延遲取貨及第三方盜竊的費用，布薯恕不負責。
                                    </li>
                                    <li>所有訂單將於香港以順豐快遞 (港澳/台灣/中國大陸)／EMS (海外地區)寄出，發貨後會以電郵通知
                                    </li>
                                </ul>
                        ...
                        <li><a class="subheading-a" href="#"> 運送安排
                            ...
                            <div class="content-div">
                                ...
                                所有現貨或訂造產品:<br>
                                滿港幣$500豁免運費，港幣$500以下將會安排順豐<span
                                    class="pink-orange-txt">貨到付款（到付）</span>，由收件方自行支付運費。因此運貨於購物車顯示為零，但不等於免費或由本店支付，實際運費以順豐交收貨件時支付的運費為準。
                                <br><br>
                                購買布料: 凡購買Marimekko/SOUSOU 布料的訂單不包括運費，亦不能享有訂單滿$500免運費條款。<br>
                                日本/其他布料滿港幣$500均有免運服務。<br><br>

                                台灣:<br><br>

                                所有台灣訂單滿港幣$800免運費，港幣$800以下將會安排順豐<span
                                    class="pink-orange-txt">貨到付款（到付）</span>，由收件方自行支付運費。因此運貨於購物車顯示為零，但不等於免費或由本店支付，實際運費以順豐交收貨件時支付的運費為準。<br><br>

                                台灣客戶需要提供以下資料作報關之用<br>
                                - 收件人的真實地址<br>
                                - 收件人身份證真實名字<br>
                                - 收件人身份證號碼<br><br>

                                布薯並不會負責中國海關之額外關稅 (如有)。<br><br>

                                中國內地：所有中國內地訂單不包括運費，將會安排順豐<span
                                    class="pink-orange-txt">貨到付款（到付）</span>，由收件方自行支付運費。運費會以地區，物品重量為基準所計算。<br><br>

                                中國內地客戶需要提供以下資料作報關之用<br>
                                - 收件人的真實地址<br>
                                - 收件人身份證真實名字<br>
                                - 收件人身份證號碼<br>
                                - 收件人身分證正面及背面影像<br><br>
                                ...
                                其他海外地區<br>
                                所有其他海外地區訂單不包括運費，將會安排香港郵政EMS，每張訂單劃一收取運費港幣HK$180。
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="content-div">
                                <ul class="dot-ul mb-3">


                                    <li> 每一件產品皆為手工製作，實際布料拼接的順序與位置，與產品照片將不完全相同，敬請理解。實品可能存在細微色差，不接受上述原因之退換貨。</li>
                                    <li> 所有客製産品，除品質有損壞問題外，否則一律不能退/換貨，請各顧客於惠顧前考慮清楚，敬請諒解。</li>
                                    <li> 請確保退貨商品及其包裝完整，任何附屬配件 (如有) (請必須摺好入回包裝袋內，只限一次，不設退款服務)。</li>
                                    <li> 如符合條件退換，請先於退貨前聯絡我們(Whatsapp/ Instagram/ Facebook 均可)，布薯將會提供地址安排退換</li>
                                    <li> 如發現退換貨商品並不符合完整退換貨條件，我們會把退貨產品寄回至客戶所提供之送貨地址，客戶需自行承擔運費。</li>
                                    <li> 缺貨： 如出現缺貨， 布薯將會安排全數退款。為免缺貨， 請儘快退回貨品。</li>

                                </ul>
                                如商品有以下情形，恕無法辦理退換貨：

                                <ul class="dot-ul mb-3 mb-3">
                                    <li>超過7天及非本次退貨訂單申請的退貨商品。</li>
                                    <li>非全新商品：如退回的貨品有明顯污漬或氣味，使用過造成磨損髒污、下過水、沾有化妝品或任何人為損毀，我們將有權不予退換，我們對貨品是否存在明顯的污漬或氣味問題會保留最終決定權。
                                    </li>
                                    <li>非完整包裝：完整包裝應包括貨品、包裝袋及附屬配件。</li>
                                    <li>已在商品上加工，例如：繡花、裁剪、打印等非商品原樣。</li>
                                    <li>由於人手製作，貨品的尺寸或可能存在輕微誤差（1~3CM），此屬正常情況，不能因為貨品存在輕微尺寸誤差而要求退換。</li>
                                </ul>


                                布薯保留一切修訂條款及細則之權利，毋須另行通知。 <br>
                                如有任何爭議，將以布薯之決定為最終裁判。
                            </div>
                        </li>
